...
# verificare se c'è un modo per fare in modo che il server sia in ascolto su tutte le porte
# verificare se c'è un modo per fare in modo che il server sia in ascolto su tutte le ip    
